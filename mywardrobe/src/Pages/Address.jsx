...
export function Address()
{
    ...
    return (
        <Box align={"center"} m={"auto"} width={{base:"95%", md:"80vw",lg:"70vw"}} >
            <Text fontWeight={500} fontSize={24} mb={7} >ADD NEW ADDRESS</Text>
            <Box align={"left"} width={"100%"} pb={5} borderBottom={"8px solid #eeeeee"} >
                <Text fontSize={16} fontWeight={500} mb={2}>Contact</Text>
                <Flex justify={"space-between"}>
                    <Box>
                    <Input focusBorderColor='black.400' placeholder="Please enter your name" border={"1px solid red"} onChange={(e)=>setName(e.target.value)}/>
                    </Box>
                    <Input
                    width={"50%"}
                    type="number"
            ...
            <Box align={"left"} width={"100%"} pt={5} >
                ...
                <Flex justify={"space-between"}>
                    <Input focusBorderColor='black.400' placeholder="Pincode" border={"1px solid red"} onChange={(e)=>setPincode(e.target.value)}/>
                    <Input focusBorderColor='black.400' placeholder="City" border={"1px solid red"} onChange={(e)=>setCity(e.target.value)}/>
                    <Input focusBorderColor='black.400' placeholder="State" border={"1px solid red"} onChange={(e)=>setState(e.target.value)}/>
                </Flex>
                <Box mb={5}>
                <Input width={{base:"100%", md:"50vw",lg:"30vw"}} focusBorderColor='black.400' placeholder="Address" border={"1px solid red"} mt={5} onChange={(e)=>setAddress(e.target.value)} />
                </Box>
                <Box>
                ...
                <Flex mt={10} justify={"space-between"}>
                    <Link to="/bag"><Button backgroundColor={"#ff9797"}>Back</Button></Link>
                    <Button backgroundColor={"#ff9797"} onClick={checkout}>Checkout</Button>
                </Flex>
            </Box>
        </Box>
    )
